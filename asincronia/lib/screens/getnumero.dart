...
class _ListScreenState extends State<ListScreen> with TickerProviderStateMixin {
  ...
  var getnumero1 = 0, getnumero2 = 0, getnumero3 = 0;
  ...
  void initState() {
    ...
    colorAnimation =
        ColorTween(begin: Colors.white, end: const Color.fromARGB(255, 251, 17, 0)).animate(controller);
    colorAnimation2 =
        ColorTween(begin: Colors.white, end: const Color.fromARGB(255, 255, 17, 0)).animate(controller2);
    colorAnimation3 =
        ColorTween(begin: Colors.white, end: const Color.fromARGB(255, 255, 17, 0)).animate(controller3);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: Center(
              child: const Text('Asynchronous calls', textAlign: TextAlign.center))),
